...
-- Insert Ocorrencias
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-01-15 10:00:00', 'OC001', 150.00, 2, true, 1, 1, 1);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-02-20 11:30:00', 'OC002', 200.00, 1, false, 2, 2, 2);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-03-25 09:45:00', 'OC003', 180.00, 3, true, 3, 3, 3);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-04-10 14:15:00', 'OC004', 250.00, 2, true, 4, 4, 4);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-05-05 08:00:00', 'OC005', 220.00, 1, false, 5, 5, 5);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-06-12 13:30:00', 'OC006', 300.00, 4, true, 1, 2, 3);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-07-18 16:45:00', 'OC007', 350.00, 2, true, 2, 3, 4);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-08-22 12:00:00', 'OC008', 400.00, 3, false, 3, 4, 5);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-09-30 10:30:00', 'OC009', 450.00, 1, true, 4, 5, 1);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-10-05 15:00:00', 'OC010', 500.00, 2, true, 5, 1, 2);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-11-05 16:00:00', 'OC011', 150.00, 4, false, 2, 1, 4);
INSERT INTO Ocorrencia (data, codigo_ocorrencia, valor, duracao_horas, aprovado, paciente_id, doenca_id, dentista_id) VALUES ('2025-12-05 18:00:00', 'OC012', 100.00, 5, true, 4, 3, 5);
